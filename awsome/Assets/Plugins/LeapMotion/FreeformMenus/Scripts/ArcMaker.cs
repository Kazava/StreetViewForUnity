...
public class ArcMaker : MonoBehaviour {
	...
	void Start() 
	{
		...
		gameObject.layer = 8;
		gameObject.GetComponent<Renderer>().material.shader = _trasparent;
	...
	private void findChildren()
	{
		...
		_activeSprite.GetComponent<Renderer>().enabled = false;
		_inactiveSprite.GetComponent<Renderer>().enabled = false;
		_textLabel.GetComponent<Renderer>().enabled = false;
	}
	...
	public void makeActive()
	{
		...
		case MenuBehavior.MenuType.ICON:
			...
			{
				_activeSprite.GetComponent<Renderer>().material.color = new Color(1.0f,1.0f,1.0f, 1.0f);
			}
			break;
	...
	public void makeInactive()
	{
		...
		case MenuBehavior.MenuType.ICON:
			...
			{
				_activeSprite.GetComponent<Renderer>().material.color = new Color(1.0f,1.0f,1.0f, 0.6f);
			}
			break;
		case MenuBehavior.MenuType.TEXT:
			break;
